...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default="charts/rt_closeness_to_clangO1_from_clangO0.png",
        help="Output plot path (default: charts/rt_closeness_to_clangO1_from_clangO0.png)",
    )
...
def main() -> None:
    ...
    plt.title("Runtime closeness to clangO1 (clangO0 -> clangO1 scale)")
