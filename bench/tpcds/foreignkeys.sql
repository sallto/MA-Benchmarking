...
alter table catalog_returns add foreign key (cr_returning_cdemo_sk) references customer_demographics (cd_demo_sk);
...
alter table inventory add foreign key (inv_item_sk) references item (i_item_sk);
